...
switch ($_POST['function']) {
    ...
    case 'save-articles':
        die(sb_json_response(sb_save_articles($_POST['articles'], sb_post('categories'), sb_post('translations'))));
    case 'get-articles':
    ...
    case 'send-sms':
        die(sb_json_response(sb_send_sms($_POST['message'], $_POST['to'], sb_post('template'))));
    case 'direct-message':
